...
{
    public enum ReversibleBias
    {
        None =0,
        Forward = 1,
        Backward =2
    }
    public class ReversibleArrow : StraightArrow
    {
        ...
        public static readonly DependencyProperty SeparationProperty =
            DependencyProperty.Register("Separation", typeof(double), typeof(ReversibleArrow), new PropertyMetadata(4d));



        public ReversibleBias Bias
        {
            get { return (ReversibleBias)GetValue(BiasProperty); }
        ...
        public static readonly DependencyProperty BiasProperty =
            DependencyProperty.Register("Bias", typeof(ReversibleBias), typeof(ReversibleArrow), new PropertyMetadata(ReversibleBias.None));
        ...
        public override void DrawArrowGeometry(DrawingContext drawingContext, Pen arrowPen, Brush arrowBrush)
        {
            ...
            if (Bias == ReversibleBias.Forward)
            {
                bottomOffset = vector * 0.2;
                bottomScale = 0.8;

            }
            else if (Bias == ReversibleBias.Backward)
            {
